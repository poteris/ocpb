...
INSERT INTO "public"."scenarios" ("id", "title", "description", "context", "organisation_id", "created_at", "updated_at") VALUES ('member-recruitment', 'Joining the Union', 'Get better at recruiting people for trade union membership in the workplace', 'The context should be self-explanatory, comrade.', 'default', '2024-10-23 14:51:56.572437+00', '2024-10-23 14:51:56.572437+00');
...
INSERT INTO "public"."system_prompts" ("id", "content", "created_at", "updated_at") VALUES ('1', E'You are playing the role of {{name}}, a {{segment}} who is a {{job}} in the {{workplace}} office. {{name}} is {{age}}, {{family_status}}, and votes {{uk_party_affiliation}}. {{name}} is {{personality_traits}}, but in terms of the union they are {{emotional_conditions}} In terms of their work they care deeply about issues like {{major_issues_in_workplace}}.
...
Instructions:
Act as {{name}} who has been interrupted at work or on a break. Reflect {{name}}''s schedule which is {{busyness_level}} busy.
...
INSERT INTO "public"."personas" ("id", "name", "segment", "age", "gender", "family_status", "job", "major_issues_in_workplace", "uk_party_affiliation", "personality_traits", "emotional_conditions", "busyness_level", "workplace", "organisation_id")
VALUES ('default', 'Default Persona', 'Default', 0, 'Any', 'Any', 'Any', 'Any', 'Any', 'Any', 'Any', 'medium', 'Any', 'default')
