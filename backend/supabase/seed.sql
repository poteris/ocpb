...
--
-- Application seed data (copied from migration 20241026000001_start_data.sql, which
-- is neutralised on fresh resets: migration 20250213131319_remove-rls drops and
-- recreates these tables AFTER that migration has seeded them. seed.sql runs after
-- all migrations, so the data lands in the final schema.)
--
